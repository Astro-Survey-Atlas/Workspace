...
export const CURATED_SURVEYS: readonly SurveyRecord[] = [
  ...
  },
  {
    ...
    releases: [release("panstarrs-dr1", "DR1", {
      ...
      releasedYear: 2016,
      modalities: ["imaging", "photometry", "catalog"],
      products: [{ name: "DR1 stacked color imaging", modality: "imaging", description: "Stacked i/r/g image product represented by the CDS HiPS coverage." }],
  ...
  },
  {
    ...
    releases: [release("2mass-all-sky", "All-Sky Release", {
      ...
      releasedYear: 2003,
      modalities: ["imaging", "photometry", "infrared", "catalog"],
      products: [{ name: "J-band imaging", modality: "infrared", description: "All-Sky J-band atlas image coverage represented by the CDS/IRSA HiPS MOC." }],
      coverage: { status: "verified", summary: "All-sky J-band image coverage; 6x observations and special mosaics are separate products.", sourceUrl: "https://irsa.ipac.caltech.edu/Missions/2mass.html" },
    })],
  },
  {
    id: "allwise",
    ...
    releases: [release("allwise", "AllWISE", {
      ...
      releasedYear: 2013,
      modalities: ["imaging", "photometry", "infrared", "catalog"],
      products: [{ name: "W1 imaging", modality: "infrared", description: "AllWISE W1 image coverage represented by the CDS/IRSA HiPS MOC." }],
      coverage: { status: "verified", summary: "Static W1 sky coverage; temporal completeness requires an exposure-level model.", sourceUrl: "https://irsa.ipac.caltech.edu/Missions/wise.html" },
    })],
  },
  {
    id: "kids",
