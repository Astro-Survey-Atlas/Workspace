...
const definitions: readonly PackageDefinition[] = [
  {
    ...
    sources: [{ label: "Euclid Q1", url: "https://www.euclid-ec.org/science/q1/", authority: "official-overview" }],
  },
  {
    ...
    sources: [{ label: "GALEX GR6/GR7 HiPS MOC", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=CDS%2FP%2FGALEXGR6_7%2Fcolor&get=record&fmt=json", authority: "CDS", license: "ODbL-1.0 derivative" }],
  },
  {
    ...
    sources: [{ label: "Legacy Surveys DR10 HiPS MOC", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=CDS%2FP%2FDESI-Legacy-Surveys%2FDR10%2Fcolor&get=record&fmt=json", authority: "CDS", license: "ODbL-1.0 derivative" }],
  },
  {
    ...
    sources: [{ label: "SDSS DR9 HiPS MOC", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=CDS%2FP%2FSDSS9%2Fcolor&get=record&fmt=json", authority: "CDS", license: "ODbL-1.0 derivative" }],
  },
  {
    ...
    sources: [{ label: "HSC-SSP PDR2 HiPS MOCs", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=CDS%2FP%2FHSC%2FDR2%2Fwide%2Fcolor-i-r-g%2CCDS%2FP%2FHSC%2FDR2%2Fdeep%2Fcolor-i-r-g&get=record&fmt=json", authority: "CDS", license: "ODbL-1.0 derivative" }],
  },
  {
    ...
    sources: [{ label: "Published HST HiPS MOC union", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=*P%2FHST%2F*&get=record&fmt=json", authority: "CDS", license: "ODbL-1.0 derivative" }],
  },
  {
    ...
    sources: [{ label: "Pan-STARRS1 DR1 HiPS MOC", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=CDS%2FP%2FPanSTARRS%2FDR1%2Fcolor-i-r-g&get=record&fmt=json", authority: "CDS", license: "ODbL-1.0 derivative" }],
  },
  {
    ...
    sources: [{ label: "DES DR2 HiPS MOC", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=CDS%2FP%2FDES-DR2%2FColorIRG&get=record&fmt=json", authority: "CDS", license: "ODbL-1.0 derivative" }],
  },
  {
    ...
    sources: [{ label: "2MASS J-band HiPS MOC", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=CDS%2FP%2F2MASS%2FJ&get=record&fmt=json", authority: "CDS/IRSA", license: "ODbL-1.0 derivative" }],
  },
  {
    ...
    sources: [{ label: "AllWISE W1 HiPS MOC", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=CDS%2FP%2FallWISE%2FW1&get=record&fmt=json", authority: "CDS/IRSA", license: "ODbL-1.0 derivative" }],
  },
  {
    ...
    sources: [{ label: "KiDS DR5 gri HiPS MOC", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=CDS%2FP%2FKiDS%2FDR5%2Fcolor-gri&get=record&fmt=json", authority: "KiDS/CDS", license: "CC BY 4.0 upstream; ODbL-1.0 derivative" }],
  },
  {
    ...
    sources: [{ label: "NVSS HiPS MOC", url: "https://alasky.cds.unistra.fr/MocServer/query?ID=CDS%2FP%2FNVSS&get=record&fmt=json", authority: "CDS", license: "ODbL-1.0 derivative" }],
  },
];
...
for (const definition of definitions) {
  ...
  packages.push({
    ...
    releases: [...new Set(footprints.map((footprint) => footprint.releaseId))],
    version: "2.0.0",
