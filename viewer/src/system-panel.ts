...
export class SystemPanel {
  ...
  async activate(): Promise<void> {
    ...
    this.renderProviders(); this.renderServers();
  }
  ...
  private async saveProvider(): Promise<AiProviderRecord> {
    ...
    byId<HTMLDialogElement>("ai-provider-dialog").close(); this.renderProviders(); notifyWorkspace("AI Provider 已保存", saved.name, { tone: "success" });
    return saved;
  }
  ...
  private async saveServer(): Promise<McpServerRecord> {
    ...
    byId<HTMLDialogElement>("mcp-server-dialog").close(); this.renderServers(); notifyWorkspace("MCP Server 已保存", saved.name, { tone: "success" });
    return saved;
  }
